 ...
 * @subpackage Hostaway_Bub/public
 */
...
class Hostaway_Bub_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/hostaway-bub-public.css', array(), $this->version, 'all' );
