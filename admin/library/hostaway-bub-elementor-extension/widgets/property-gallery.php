 ...
 * @since 1.0.0
 */
class Hostaway_Property_Gallery extends \Elementor\Widget_Base
{
    ...
    {
        return __('Property Gallery', 'hostaway-elementor-extension');
    }
    ...
    protected function render()
    {
        ...
        if( $display ) {
            echo do_shortcode('[display_gallery propertyid='.$property_id.']');
        }
    }
}
